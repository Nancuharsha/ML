# -*- coding: utf-8 -*-
"""
Created on Mon Feb 12 00:12:49 2018
        ...
        while True:
            ...
            for i in centroids:
                ...
                for featureset in data:
                    ...
                    #Below step is largest or time taking step with **2 
...
for classification in clf.classifications:
    ...
    for featureset in clf.classifications[classification]:
        plt.scatter(featureset[0],featureset[1],color=color,marker='x',s=100,linewidths=2)
for c in centroids:
    plt.scatter(centroids[c][0],centroids[c][1],color='k',s=100,marker='*',linewidths=2)
plt.show()           
